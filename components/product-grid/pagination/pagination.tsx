...
const Pagination: FC<IPaginationProps> = ({page, totalPages, onChange}) => {
    if (totalPages <= 1) return null;

    return (
        <div className={styles.wrap}>
            <IconButton disabled={page === 1} onClick={() => onChange(1)} aria-label="First page">
                <CaretDoubleLeftIcon />
            </IconButton>
            ...
            <IconButton disabled={page === totalPages} onClick={() => onChange(totalPages)} aria-label="Last page">
